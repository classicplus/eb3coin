...
#if defined(NDEBUG)
# error "Eb3coin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x9d1761cae9b5527f412aa7b9a37c30086d4417ce072e3534474b94c92d0e0929");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Eb3coin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 84000000); // Eb3coin: 84000k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 60; // Eb3coin: 2 minutes
static const int64 nTargetSpacing = 1 * 30; // Eb3coin: half minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Eb3coin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Eb3coin: Special short-term limits to avoid 10,000 BDB lock limit:
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Eb3coin: increase each by adding 2 to bitcoin's value.
